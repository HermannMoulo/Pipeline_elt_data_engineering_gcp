...
PROJECT_ID = "polished-coil-458209-n5"
#BUCKET_NAME = f"{PROJECT_ID}-bucket"
BUCKET_NAME = "yellow-taxi-trips-analytics-bucket"
GCS_FOLDER = "dataset/trips/"
GCS_LOG_FOLDER = "from-git/logs/"
#TABLE_ID = f"{PROJECT_ID}.raw_yellowtrips.trips"
TABLE_ID = "polished-coil-458209-n5.raw_yellowtrips.trips"
...
def get_existing_files():
    ...
    query_job = bq_client.query(query,project=PROJECT_ID)  # Specify the dataset location
